...
transTopDef x = case x of
  ...
  ClassDef _ classheader classblock -> failure x
...
transStmt x = case x of
  ...
  For _ type_ ident1 ident2 stmt -> failure x
...
transType x = case x of
  CustomType _ ident -> failure x
  Int _ -> failure x
  Str _ -> failure x
  Bool _ -> failure x
  Void _ -> failure x
  Array _ type_ -> failure x
transClassHeader :: Show a => ClassHeader a -> Result
transClassHeader x = case x of
  ClassDec _ ident -> failure x
  ClassDecExt _ ident1 ident2 -> failure x
transClassBlock :: Show a => ClassBlock a -> Result
transClassBlock x = case x of
  ClBlock _ classstmts -> failure x
transClassStmt :: Show a => ClassStmt a -> Result
transClassStmt x = case x of
  ClVar _ type_ items -> failure x
  ClFun _ type_ ident args block -> failure x

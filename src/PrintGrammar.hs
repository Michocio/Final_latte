...
instance Print (TopDef a) where
  prt i e = case e of
    ...
    ClassDef _ classheader classblock -> prPrec i 0 (concatD [prt 0 classheader, prt 0 classblock])
...
instance Print (Stmt a) where
  prt i e = case e of
    ...
    Incr _ lvalue -> prPrec i 0 (concatD [prt 0 lvalue, doc (showString "++"), doc (showString ";")])
    Decr _ lvalue -> prPrec i 0 (concatD [prt 0 lvalue, doc (showString "--"), doc (showString ";")])
    ...
    For _ type_ id1 id2 stmt -> prPrec i 0 (concatD [doc (showString "for"), doc (showString "("), prt 0 type_, prt 0 id1, doc (showString ":"), prt 0 id2, doc (showString ")"), prt 0 stmt])
...
instance Print (Type a) where
  prt i e = case e of
    CustomType _ id -> prPrec i 0 (concatD [prt 0 id])
...
instance Print (ClassHeader a) where
  prt i e = case e of
    ClassDec _ id -> prPrec i 0 (concatD [doc (showString "class"), prt 0 id])
    ClassDecExt _ id1 id2 -> prPrec i 0 (concatD [doc (showString "class"), prt 0 id1, doc (showString "extends"), prt 0 id2])

instance Print (ClassBlock a) where
  prt i e = case e of
    ClBlock _ classstmts -> prPrec i 0 (concatD [doc (showString "{"), prt 0 classstmts, doc (showString "}")])

instance Print (ClassStmt a) where
  prt i e = case e of
    ClVar _ type_ items -> prPrec i 0 (concatD [prt 0 type_, prt 0 items, doc (showString ";")])
    ClFun _ type_ id args block -> prPrec i 0 (concatD [prt 0 type_, prt 0 id, doc (showString "("), prt 0 args, doc (showString ")"), prt 0 block])
  prtList _ [] = concatD []
  prtList _ (x:xs) = concatD [prt 0 x, prt 0 xs]
